...
const en = {
  ...
  [StatusCodes.INTERNAL_SERVER_ERROR]: {
    ...
    info: 'There was a problem with your last action. Please go back and try again.<br><br>' +
          'if the problem persist please contact the Tribunal <br><br>' +
          'Find a court or tribunal - <a href=\'https://www.gov.uk/criminal-injuries-compensation-tribunal/appeal-to-tribunal\'>GOV.UK<\a><br><br><br>',
  },
};
